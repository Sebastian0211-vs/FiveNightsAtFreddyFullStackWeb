...
export {
    LettryMenu, FredMenu, FreddyMenu, FatMenu,
    noiseMenu, whiteMenu,
    mainRoomDoorLeft, mainRoomDoorRight,
    chicajumpscare, bonnieJumpscare, foxyJumpscare,
    goldenFreddyJumpscare, freddyJumpscare, freddyJumpscarePowerOut,
    officeFreddy,
    fanAnimation,
    foxyRun,
    tabletAnimation,
