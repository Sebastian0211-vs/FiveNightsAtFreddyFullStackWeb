...
export const NIGHT_SECS    = 535;
export const SECS_PER_HOUR = NIGHT_SECS / 6;

// Power drained passively every N seconds (0 = no passive drain on night 1)
export const PASSIVE_INTERVAL = { 1: 0, 2: 6, 3: 5, 4: 4, 5: 3, 6: 3, 7: 3 };

export const base_ai_level = {
